        ...
        <div className="min-h-screen flex items-center justify-center bg-background px-4">
            <div className="max-w-md w-full space-y-8 bg-card p-8 rounded-xl border border-border">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">Already have an account? <Link href="/login" className="text-primary hover:text-primary/90">Sign in</Link></p>
                </div>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            />
                            {errors.password && <span className="text-xs text-destructive">Password is required (min 6 chars)</span>}
                        </div>
                    </div>
